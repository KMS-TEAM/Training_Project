...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/rec/img/redo.jpg"), QSize(), QIcon::Normal, QIcon::Off);
        actionRedo->setIcon(icon8);
        actionAbout_NotePad = new QAction(MainWindow);
        actionAbout_NotePad->setObjectName(QString::fromUtf8("actionAbout_NotePad"));
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/rec/img/i.jpg"), QSize(), QIcon::Normal, QIcon::Off);
